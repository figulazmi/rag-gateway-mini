...
| Features | [`features/SS-1-SEMI-AUTO-CAPTURE.md`](features/SS-1-SEMI-AUTO-CAPTURE.md) | Semi-auto capture workflow planned for implementation | SS-1 | Implement user-confirmed capture assistant to reduce manual effort by 90% |
