...
Next: P2.8 - harden negative-query not-found behavior
```
...
| Planning | [`planning/RAG_V2_ROADMAP.md`](planning/RAG_V2_ROADMAP.md) | Keyfacts retrieval-only production hardening | P2.8 | Read before pipeline changes |
