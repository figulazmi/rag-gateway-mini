...
```text
Done: P1-3, P1-4, and P1-5 completed in security tracker; see owning trackers for full history
Open: Security P2-1
Blocked: none listed here
Deferred: P2.2, P2.2-B, OI-5
Next: Security P2-1 or choose a deferred item with approval
```
...
|---|---|---|---|---|
| Security | [`security/RAG_SECURITY_POSTURE.md`](security/RAG_SECURITY_POSTURE.md) | Long-term forensics and citation controls | P2-1 | Use security tracker for evidence and verification steps |
