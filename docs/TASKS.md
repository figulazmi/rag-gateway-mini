...
```text
Done: P1-3 completed in security tracker; see owning trackers for full history
Open: none listed here
Blocked: none listed here
Deferred: P2.2, P2.2-B, OI-5
Next: choose a deferred item or approve a new follow-up task
```
...
|---|---|---|---|---|
| Security | [`security/RAG_SECURITY_POSTURE.md`](security/RAG_SECURITY_POSTURE.md) | Hardening and threat controls | P1-4 | Use security tracker for evidence and verification steps |
