...
| **Context Precision** | Fraction of retrieved chunks actually used | ≥ 0.60 | 0.6289 keyfacts hybrid 12-query smoke after expected-id scorer tightening (2026-05-07) | `[x] MET` |
| **Latency p50** | End-to-end query time, VM B1 CPU | ≤ 1.5s | 1574.9ms keyfacts grounded 12-query smoke (2026-05-07) | `[ ] NOT MET` |
| **Latency p95** | End-to-end query time, VM B1 CPU | ≤ 4.0s | 2556.2ms keyfacts grounded 12-query smoke (2026-05-07) | `[x] MET` |
| **Hallucination Rate** | Claims with zero chunk grounding | ≤ 5% | 28.6% on 7/7 keyfacts end-to-end smoke after context-derived candidate answers (2026-05-07) | `[ ] NOT MET` |
